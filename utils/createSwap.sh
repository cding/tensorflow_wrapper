#!/bin/bash
# NVIDIA Jetson TX1
# https://github.com/jetsonhacks/installTensorFlowTX2/blob/master/createSwapfile.sh
# Example Usage: ./createSwapfile.sh -d ~/swap -s 8
#   build a 8GB swapfile on the eMMC in ~/swap
#
